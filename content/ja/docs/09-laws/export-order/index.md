...
| 別表第3の3 | 少額特例の上限が**5万円**になる品目 | 第4条第1項第5号 | 5・7・8・9・10・12・13項の一部の品目（**告示貨物**：平成13年経済産業省告示第758号で指定）と、15項の全ての貨物。WAの**Sensitive List**（機微品目リスト）の貨物に**おおむね対応**（※） | [05](../../05-exceptions/) |
...
> ※ 別表第3の3とワッセナー・アレンジメント（WA）のリストの関係
> - **15項**はWAの**Very Sensitive List**（特に機微な品目リスト）にあたります（CISTECジャーナル 2016年9月号）。
> - **告示貨物**は、WAの2025年版リストと突き合わせると、**Sensitive List**のうちVery Sensitive List以外の貨物と構成がよく一致します（例：8項↔4.A.1.a.2、10項(1)↔6.A.1、10項(2)↔6.A.2、12項(1)↔8.A.1、5項(18)↔1.C.10）。ただし、この対応を明言した経済産業省の資料は確認できておらず、本サイトの整理です。
> - 仕様の細部はWAのリストと一致しないことがあり（例：1.A.2.aの複合材料は、使う繊維によって15項と5項(18)に分かれる）、告示もWAのリストの改定に合わせて改正されます。判定は必ず最新の貨物等省令と告示で行ってください。
